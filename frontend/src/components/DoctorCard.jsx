...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
      <div><img src={photo} className="w-full" alt="" /></div>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        ...
        <Link to={`/doctors/${doctor._id}`} className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] my-[30px] mx-auto flex items-center justify-center gruop hover:bg-primaryColor hover:border-none">
